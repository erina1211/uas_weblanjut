...
if (isset($_POST["cari"])) {
    ...
    $kantin = cari_kantin($_POST["search"]);
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="display-4">Kantin</h1>
                    <p class="lead">Temukan berbagai makanan dan minuman lezat di kantin kita.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php if (isset($error)) : ?>
        <div class="d-flex flex-column align-items-center justify-content-center w-100 h-100 mt-3 text-center">
            ...
            <p class="text-center">Maaf, kantin yang Anda cari tidak tersedia.</p>
        </div>
    <?php endif; ?>
    <section class="light">
        <div class="container py-2">
            <?php foreach ($kantin as $ktn): ?>
                <article class="postcard light blue">
                    <img class="postcard__img" src="images/product/<?= $ktn["img"] ?>" alt="<?= $ktn["alt"] ?>" />
                    <div class="postcard__text text-dark ">
                        <h1 class="postcard__title blue ms-3">Warung <?= $ktn["nama_warung"] ?></h1>
                        <div class="postcard__subtitle small ms-3">
                            <i class="fas fa-calendar-alt mr-2"></i>
                            <span><?= $ktn["date"] ?></span>
                        </div>
                        <div class="postcard__bar ms-3"></div>
                        <div class="postcard__preview-txt ms-3"><?= $ktn["deskripsi"] ?></div>
                        <button class="button button-blue ms-3">
                            <div class="button-outer">
                                <a href="kantin_menu.php?id=<?= $ktn["no"] ?>">
