...
$id = intval($_GET['id']); // Fungsi dari intval adalah untuk mengonversi suatu nilai menjadi bilangan bulat (integer)
$menu = query("SELECT * FROM menu WHERE no = $id")[0];
$nama_warung = query("SELECT nama_warung FROM kantin");
...
<body>
    ...
    <div class="header">
        <div class="container">
            ...
            <p class="text-center">Silahkan Ubah menu dibawah ini</p>
        </div>
    </div>
    <div class="tambah_menu">
        <div class="container mt-5">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="rate" name="rate" value="<?= $menu['rate']; ?>" required>
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-control" id="type" name="type" required>
                        ...
                        <option value="cemilan" <?= $menu['type'] === 'cemilan' ? 'selected' : ''; ?>>Cemilan</option>
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="nama_warung" name="nama_warung" required>
                        <?php foreach ($nama_warung as $nw): ?>
                            <option value="<?= $nw['nama_warung']; ?>" <?= $menu['nama_warung'] === $nw['nama_warung'] ? 'selected' : ''; ?>>
                                <?= $nw['nama_warung']; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="mb-3">
                    <label for="img" class="form-label">Gambar Baru (opsional)</label>
                    <input type="file" class="form-control" id="img" name="img">
                </div>
                <div class="mb-3">
                    <label for="alt_makanan" class="form-label">Alt (Deskripsi Gambar)</label>
                    <input type="text" class="form-control" id="alt_makanan" name="alt_makanan" value="<?= $menu['alt_makanan']; ?>" required>
                </div>
                <button type="submit" name="submit" class="btn btn-primary">Ubah Menu</button>
