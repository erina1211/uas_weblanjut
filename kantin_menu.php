...
$kantin = query("SELECT * FROM kantin WHERE no = $id")[0];
if (isset($_POST["cart"])) {
...
<body>
    ...
    <section class="kantin">
        <!-- Menampilkan Warung dan menunya -->
        <div class="container">
            <div class="row">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/product/<?= $kantin['img'] ?>" class="d-block w-200" alt="<?= $kantin['nama_warung'] ?>" style="height: 500px; width: 100%; object-fit: cover;">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="text-light"><?= $kantin['nama_warung'] ?></h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        ...
                        $id = $_GET['id'];
                        $menus = query("SELECT menu.* FROM menu JOIN kantin ON menu.nama_warung = kantin.nama_warung WHERE kantin.no = $id");
