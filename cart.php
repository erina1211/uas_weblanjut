...
session_start();
$_SESSION['dari_cart'] = true;
$_SESSION['boleh_hapus'] = true;
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            if (empty($cartItems)) {
                                echo "<tr><td colspan='8' class='text-center fs-1'>Keranjang Anda kosong</td></tr>";
                            } else {
                            ...
                            ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td>
                                            <img src="images/product/<?= htmlspecialchars($item['img']); ?>" alt="<?= htmlspecialchars($item['nama_makanan']); ?>" class="img-fluid" style="width: 100px; height: 100px;">
                                        <td><?= htmlspecialchars($item['nama_makanan']); ?></td>
                                        <td><?= htmlspecialchars($item['nama_warung']); ?></td>
                                        <td>Rp <?= number_format($item["harga"], 3, ',', '.') ?></td>
                                        <td><?= htmlspecialchars($item['jumlah']); ?></td>
                                        <td>Rp <?= number_format($item["total"], 3, ',', '.') ?></td>
                                        <td>
                                            <a href="hapus_keranjang.php?id=<?= $item['no']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus keranjang?');">
                                                Hapus
                                            </a>
                                        </td>
                                    </tr>
                    ...
                    <?php if (!empty($cartItems)) : ?>
                        <div class="bayar">
                            <h3>Total Harga: Rp <?= number_format($totalHarga, 3, ',', '.') ?></h3>
                            <a href="index.php" class="btn btn-secondary btn-lg me-3">Kembali ke Warung</a>
                            <a href="checkout.php" class="btn btn-success btn-lg">Bayar</a>
                        </div>
                    <?php endif; ?>
